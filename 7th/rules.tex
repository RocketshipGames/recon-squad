...
% special rule earn one Pain Token for every~3 opposing non-vehicle
% models they eliminate from play.

% Necron models only count after having failed their Reanimation
% Protocols.
